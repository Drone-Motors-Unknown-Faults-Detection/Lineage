...
def align_rows(*arrays):
    ...
    aligned_arrays = [arr[:min_rows, :] for arr in arrays]
...
def process_group(group_label, screws):
    ...
    try:
        ...
        # 對齊行數
        feature_Current, feature_X, feature_Y, feature_Z, feature_Temp = align_rows(feature_Current, feature_X, feature_Y, feature_Z, feature_Temp)
