...
rawDataDirectories = {
    motor: {
        **{
        ...
        '1': os.path.join(rootDir, '階段2', motor, '8000rpm', '1screw'),
        '3_14': os.path.join(rootDir, '階段2', motor, '8000rpm', '3_14screws'),
        '4_146': os.path.join(rootDir, '階段2', motor, '8000rpm', '4_146screws'),
    }
