...
rawDataDirectories = {
    motor: {
        **{
            screws: os.path.join(rootDir, '階段2', motor, '11000rpm', f'{screws}screws')
            for screws in screws_config
        },
        '1': os.path.join(rootDir, '階段2', motor, '11000rpm', '1screw'),
        '3_14': os.path.join(rootDir, '階段2', motor, '11000rpm', '3screws_14'),
        '4_146': os.path.join(rootDir, '階段2', motor, '11000rpm', '4screws_146'),
    }
    ...
    try:
        ...
        for dataset in rawdataset_list:
            ...
            if signal_columns == 'A':        
                ...
                df.columns = ['Current', 'X', 'Y', 'Z', 'Temperature', 'AmbientTemperature', 'Delta_T']
